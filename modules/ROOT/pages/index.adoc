...
[WARNING]
The Query API is currently only available on Aura.
To run queries over HTTP on on-prem instances, use the link:https://neo4j.com/docs/http-api/current/[HTTP API].
