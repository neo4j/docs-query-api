...
- Introduce `dbms.bolt.local_connector.object_transport_enabled` setting. This setting enables the use of local objects instead of Packstream when Query API communicates with Bolt Server. This improves the performance of Query API. Default: false.
